...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body>
        {/* No-JS fallback: the scroll-reveal keeps `.rv` at opacity:0 until the
            IntersectionObserver runs, so without JS every section would stay
            invisible. This reveals them for no-JS users (JS users keep the
            fade-in). */}
        <noscript>
