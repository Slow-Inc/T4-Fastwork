        ...
        <section className="section section-page">
          ...
          <div className="page-head rv">
            ...
            <p className="page-lead">
              {t(
                'T4 Labs คือพาร์ตเนอร์ด้านวิศวกรรมซอฟต์แวร์ — ประสบการณ์ 5 ปี ทำมาแล้ว 21+ โปรเจกต์ ตั้งแต่ Landing Page ไปจนถึงแพลตฟอร์มที่ซับซ้อนสูง',
                'T4 Labs is a software engineering partner — 5 years of experience, 21+ projects built, from landing pages to high-complexity platforms.',
              )}
            </p>
          </div>
