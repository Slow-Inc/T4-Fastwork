...
/** Presentational team roster — pure, unit-testable, hook-free. A directory (not a card
 * grid) so this section reads structurally different from the rest of /about
 * (Requirement §14.4). Members + org projects are injected (DB-first from the server
 * wrapper) so member edits reflect here with no component change (Epic C / C5). */
