...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      'ประสบการณ์ 7 ปี ทำมาแล้ว 21+ โปรเจกต์ คุยกับนักพัฒนาตัวจริงโดยตรง เชี่ยวชาญทั้ง Full-Stack และ AI เน้นผลลัพธ์ต่อธุรกิจ และดูแลต่อหลังส่งมอบ — ได้ทั้งงานคุณภาพและความสบายใจครับ',
    questionEn: 'Why choose T4 Labs?',
    answerEn:
      '7 years of experience, 21+ projects built, talk to real engineers directly, expertise across Full-Stack and AI, focused on business outcomes and post-delivery care — quality work with peace of mind.',
  },
];
