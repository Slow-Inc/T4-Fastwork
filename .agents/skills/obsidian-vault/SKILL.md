...
This vault is the committed, shared cross-agent knowledge base for T4 Fastwork. Only personal
`.obsidian/` UI state is gitignored. The vault is mostly flat at root level, with `Home.md` as its
Map of Content.
