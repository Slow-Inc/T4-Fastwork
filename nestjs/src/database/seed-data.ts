...
export const services = [
  {
    ...
    description:
      'พัฒนา SaaS ครบวงจร — multi-tenant, subscription, dashboard, การจัดการผู้ใช้และสิทธิ์',
    icon: 'layers',
    sortOrder: 1,
  },
  {
    ...
    description:
      'ระบบเว็บซับซ้อน เช่น marketplace, ระบบจอง, internal tools ที่ปรับแต่งตามโจทย์',
    icon: 'browser',
    sortOrder: 2,
  },
  {
    ...
    description:
      'chatbot, RAG, OCR/Document AI และ automation — ต่อยอดจากงาน LLM/OCR จริงของทีม',
    icon: 'sparkles',
    sortOrder: 3,
  },
  {
    ...
    description:
      'สร้าง MVP หรือ product จริงให้เร็ว พร้อม launch และปรับต่อยอดได้',
    icon: 'rocket',
    sortOrder: 4,
  },
  {
    ...
    description:
      'ระบบหลังบ้าน, integration ระหว่างระบบ, และ automation ลดงานซ้ำ',
    icon: 'gear',
    sortOrder: 5,
  },
  {
    ...
    description:
      'ไม่แน่ใจว่าต้องการอะไร — คุยกับทีมเพื่อออกแบบทางออกทางเทคนิคที่เหมาะกับธุรกิจ',
    icon: 'chat',
    sortOrder: 6,
  },
] as const;
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      'ประสบการณ์ 5 ปี ทำมาแล้ว 21+ โปรเจกต์ คุยกับนักพัฒนาตัวจริงโดยตรง เชี่ยวชาญทั้ง Full-Stack และ AI เน้นผลลัพธ์ต่อธุรกิจ และดูแลต่อหลังส่งมอบ — ได้ทั้งงานคุณภาพและความสบายใจครับ',
  },
] as const;
