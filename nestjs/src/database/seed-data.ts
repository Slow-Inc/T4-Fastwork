...
export const faqs = [
  ...
  { category: 'about', sortOrder: 14, question: 'ทำไมต้องเลือก T4 Labs?', answer: 'ประสบการณ์ 5 ปี ทำมาแล้ว 21+ โปรเจกต์ คุยกับนักพัฒนาตัวจริงโดยตรง เชี่ยวชาญทั้ง Full-Stack และ AI เน้นผลลัพธ์ต่อธุรกิจ และดูแลต่อหลังส่งมอบ — ได้ทั้งงานคุณภาพและความสบายใจครับ' },
] as const;
